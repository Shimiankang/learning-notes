...
| Ctrl + 1         | 按实际像素展示                                               |
| Ctrl + 0         | 按窗口大小展示                                               |
| Ctrl + H         | 显示/隐藏内容（如选区、参考线、像素线）                      |
| Ctrl + R         | 显示/隐藏标尺                                                |
| Ctrl + ;         | 显示/隐藏参考线                                              |
| Ctrl + ‘         | 显示/隐藏网格                                                |
| Ctrl + Shift + ; | 开启/关闭对齐功能                                            |
| Ctrl + Alt + ;   | 锁定参考线                                                   |
| Tab              | 显示/隐藏所有面板，包括工具箱和选项栏                        |
| Shift + Tab      | 显示/隐藏除工具箱和选项栏外的面板                            |
| F                | 屏幕模式切换（标准屏幕模式->带有菜单栏的全屏模式->全屏模式） |
| F7               | 显示/隐藏图层面板                                            |
| F5               | 显示/隐藏画笔面板                                            |
| F9               | 显示/隐藏动作面板（历史记录、库）                            |
| F6               | 显示/隐藏颜色面板（属性、调整）                              |
...
1. 按住<span style="background:#F8F8F8;padding:0 5px;">alt</span>然后再点击图层前面的小眼睛图标会把除当前点击的图层其它图层都隐藏掉
2. 按住<span style="background:#F8F8F8;padding:0 5px;">ctrl</span>然后点击图层面板中的图层，会载入当前像素选区

#### 文件快捷键

| 按键                         | 描述           |
| ---------------------------- | -------------- |
| Ctrl + Shift + Alt + W       | 导出为其他格式 |
| Ctrl + Shift + Alt + S       | 导出为GIF格式  |
| Ctrl + N                     | 新建文件       |
| Ctrl + S                     | 保存           |
| Ctrl + Shift + S             | 另存为         |
| Ctrl + Z                     | 撤销           |
| Ctrl + Shift + Z 或 Ctrl + Y | 恢复/复原      |
